...
vim.keymap.set('n', '<leader>1', '1gt', { noremap = true, silent = true, desc = '[1] Go to tab 1' })
vim.keymap.set('n', '<leader>2', '2gt', { noremap = true, silent = true, desc = '[2] Go to tab 2' })
vim.keymap.set('n', '<leader>3', '3gt', { noremap = true, silent = true, desc = '[3] Go to tab 3' })
vim.keymap.set('n', '<leader>4', '4gt', { noremap = true, silent = true, desc = '[4] Go to tab 4' })
vim.keymap.set('n', '<leader>5', '5gt', { noremap = true, silent = true, desc = '[5] Go to tab 5' })
vim.keymap.set('n', '<leader>6', '6gt', { noremap = true, silent = true, desc = '[6] Go to tab 6' })
vim.keymap.set('n', '<leader>7', '7gt', { noremap = true, silent = true, desc = '[7] Go to tab 7' })
vim.keymap.set('n', '<leader>8', '8gt', { noremap = true, silent = true, desc = '[8] Go to tab 8' })
vim.keymap.set('n', '<leader>9', '9gt', { noremap = true, silent = true, desc = '[9] Go to tab 9' })
vim.keymap.set('n', '<leader>0', ':tablast<CR>', { noremap = true, silent = true, desc = '[0] Go to last tab' })
